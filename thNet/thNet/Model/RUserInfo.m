...
- (NSURL *)babySmallAvatarUrl {
    ...
    return [NSURL URLWithString:[NSString stringWithFormat:@"%@/upload/%@/%@", [[REngine shareInstance] baseUrl], @"small", _babyAvatarId]];
}
...
- (void)doSetUserInfoByJsonDic:(NSDictionary*)dic {
    ...
    for (NSDictionary*babyDic in [dic objectForKey:@"babys"]) {
        RUserInfo* babyInfo = [[RUserInfo alloc] init];
...
- (NSURL *)bgImgUrl {
    ...
    return [NSURL URLWithString:[NSString stringWithFormat:@"%@/upload/%@", [[REngine shareInstance] baseUrl], _bgImgId]];
}

+ (NSString*)getAvatarUrlWithAvatar:(NSString*)avatar size:(int)size{
    
    return [NSString stringWithFormat:@"%@/upload/%d/%@", [[REngine shareInstance] baseUrl], size, avatar];
}
...
- (NSString*)getAvatarUrlWithType:(NSString*)type{
    ...
    return [NSString stringWithFormat:@"%@/upload/%@/%@", [[REngine shareInstance] baseUrl], type, _avatar];
}
...
- (NSURL *)smallAvatarUrl {
    ...
    return [NSURL URLWithString:[NSString stringWithFormat:@"%@/upload/%@/%@", [[REngine shareInstance] baseUrl], @"small", _avatar]];
}
...
- (NSURL *)mediumAvatarUrl{
    ...
    return [NSURL URLWithString:[NSString stringWithFormat:@"%@/upload/%@/%@", [[REngine shareInstance] baseUrl], @"middle", _avatar]];
}
...
- (NSURL *)largeAvatarUrl{
    ...
    return [NSURL URLWithString:[NSString stringWithFormat:@"%@/upload/%@/%@", [[REngine shareInstance] baseUrl], @"large", _avatar]];
}
...
- (NSURL *)originalAvatarUrl {
    ...
    return [NSURL URLWithString:[NSString stringWithFormat:@"%@/upload/%@", [[REngine shareInstance] baseUrl], _avatar]];
}
